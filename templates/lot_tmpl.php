    ...
    <section class="lot-item container">
      ...
      <div class="lot-item__content">
        ...
        <div class="lot-item__right">
          ...
          <?php $time_diff = get_time_diff($lot['date_finish']);?>
            <div class="lot-item__timer timer <?php if($time_diff['hours'] < 1):?>timer--finishing<?php endif; ?>">
             <?= $time_diff['hours'].' : '.$time_diff['min'] ?>
            </div>
